...
public sealed class HistoricalClient : IHistoricalClient
{
    ...
    /// <para>
    /// For additional validation, you can use the symbology API to pre-validate symbols before calling this method.
    /// Alternatively, use <see cref="BatchSubmitJobAsync(string, IEnumerable{string}, Schema, DateTimeOffset, DateTimeOffset, CancellationToken)"/> for bulk downloads with additional options.
    /// </para>
    /// </remarks>
