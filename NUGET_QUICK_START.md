...
dotnet nuget push src/Databento.Client/bin/Release/Databento.Client.*.nupkg --source https://api.nuget.org/v3/index.json
```
...
# 4. Tag in git (replace X.Y.Z with actual version)
git tag vX.Y.Z-beta
